...
class SystemConfigSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SystemConfig
        fields = [
            'id', 'key', 'value', 'description', 'is_active', 'created_by',
            'created_at', 'updated_at', 'field_verbose_names', 'created_by_name'
        ]
...
class FranchiseConfigSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'key', 'value', 'description', 'is_active', 'franchise',
...
class NotificationTemplateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'field_verbose_names', 'created_by_name'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
...
class AuditLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AuditLog
        fields = [
            'id', 'action', 'model_name', 'object_id', 'details', 'ip_address',
            'user_agent', 'user', 'franchise', 'created_at', 'field_verbose_names',
            'user_name', 'franchise_name'
        ]
