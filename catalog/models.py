...
class Catalog(models.Model):
    ...
    menu = models.IntegerField(verbose_name="Menú")
    item_group = models.IntegerField(verbose_name="Grupo")
    ...
    usage_instructions = models.ForeignKey('Instruction', db_column='usage_instructions', on_delete=models.CASCADE, related_name='catalogs', verbose_name="Instrucciones de Uso")
